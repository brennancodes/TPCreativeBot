    ...
    client.on("interactionCreate", async interaction => {
        try {
            ...
            if (!interaction.customId.includes("ConfirmGetCurrentRating")){ return false; }
                ...
                const url = `https://tagpro-secret.koalabeast.com/mtc/rest/getcurrentrating/${map.id}`
                const imageUrl = `https://static.koalabeast.com/images/maps/${map.name.split(" ").join("_").replaceAll("_","%20").trim()}-small.png`
